const styles = {
    ...
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#DA467D]",
    button: 'w-[150px] bg-[#DA467D] h-[50px] my-3 flex items-center justify-center rounded-[20px] hover:bg-[#000000] cursor-pointer ',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#DA467D] flex items-center justify-center cursor-pointer",
    cart_button_text:"text-[#fff] text-[16px] font-[600]",
    input:"w-full border p-1 rounded-[5px]",
    activeStatus:"w-[10px] h-[10px] rounded-full absolute top-0 right-1 bg-[#DA467D]",

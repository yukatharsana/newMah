          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                within 3 days of delivery. To initiate a return, please email
                us at shifasmehendhi@gmail.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                shifasmehendhi@gmail.com, or by calling us at (035) 1433-4567
